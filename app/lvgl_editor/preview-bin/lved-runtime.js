...
var ASM_CONSTS = {
 ...
 334926: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 335009: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 335078: () => { return window.innerWidth; },  
 335108: () => { return window.innerHeight; }
};
...
var _lvgl_editor_init = Module['_lvgl_editor_init'] = wasmExports['lvgl_editor_init']
