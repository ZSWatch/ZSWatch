...
static void watchface_107_2_dial_set_weather(int8_t temp, int icon, uint16_t humidity)
{
    ARG_UNUSED(temp);
    ARG_UNUSED(icon);
    ARG_UNUSED(humidity);
...
static void watchface_107_2_dial_set_watch_env_sensors(int pressure)
{
    if (!face_107_2_dial) {
        return;
    }
