...
static void watchface_66_2_dial_set_weather(int8_t temp, int icon, uint16_t humidity)
{
    ARG_UNUSED(temp);
    ARG_UNUSED(icon);
    ARG_UNUSED(humidity);
...
void watchface_66_2_dial_show(lv_obj_t *parent, watchface_app_evt_listener evt_cb, zsw_settings_watchface_t *settings)
{
    ui_66_2_dial_evt_cb = evt_cb;

    lv_obj_clear_flag(parent, LV_OBJ_FLAG_SCROLLABLE);
    face_66_2_dial = lv_obj_create(parent);
