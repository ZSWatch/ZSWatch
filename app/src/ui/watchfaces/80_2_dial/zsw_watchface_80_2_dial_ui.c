...
static void watchface_80_2_dial_set_weather(int8_t temp, int icon, uint16_t humidity)
{
    ARG_UNUSED(humidity);
    if (!face_80_2_dial) {
        return;
...
static void watchface_80_2_dial_set_watch_env_sensors(int pressure)
{
    if (!face_80_2_dial) {
        return;
    }
...
void watchface_80_2_dial_show(lv_obj_t *parent, watchface_app_evt_listener evt_cb, zsw_settings_watchface_t *settings)
{
    ui_80_2_dial_evt_cb = evt_cb;

    lv_obj_clear_flag(parent, LV_OBJ_FLAG_SCROLLABLE);
    face_80_2_dial = lv_obj_create(parent);
    ...
    zsw_ui_notifications_area = zsw_ui_notification_area_add(face_80_2_dial);
    lv_obj_set_pos(zsw_ui_notifications_area->ui_notifications_container, -45, 35);
}
