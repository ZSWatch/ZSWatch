...
static void watchface_75_2_dial_set_watch_env_sensors(int pressure)
{
    if (!face_75_2_dial) {
        return;
    }
...
void watchface_75_2_dial_show(lv_obj_t *parent, watchface_app_evt_listener evt_cb, zsw_settings_watchface_t *settings)
{
    ui_75_2_dial_evt_cb = evt_cb;

    lv_obj_clear_flag(parent, LV_OBJ_FLAG_SCROLLABLE);
    face_75_2_dial = lv_obj_create(parent);
