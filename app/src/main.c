...
static zsw_ui_navigation_callbacks_t ui_navigation_callbacks =
{
    .on_notification_popup_request = NULL,
    .on_app_manager_request = NULL, 
    .on_app_manager_close = NULL,
    .on_notification_closed = on_popup_notifcation_closed
};
...
static void run_init_work(struct k_work *item)
{
    ...
    zsw_ui_navigation_init(&ui_navigation_callbacks);
...
static void close_popup_notification(lv_timer_t *timer)
{
    ...
    zsw_ui_navigation_clear_notification_mode();
}
...
static void open_notification_popup(void *data)
{
    ...
    if (not != NULL) {
        zsw_ui_navigation_set_notification_mode();
