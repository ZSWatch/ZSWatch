...
static void on_ScreenHumidity_Event(lv_event_t *e)
{
...
void SensorsSummary_HumidityScreen_Show(lv_obj_t *root)
{
    ...
    lv_obj_add_event_cb(root_page, on_ScreenHumidity_Event, LV_EVENT_ALL, NULL);
}

void SensorsSummary_HumidityScreen_Remove(void)
{
