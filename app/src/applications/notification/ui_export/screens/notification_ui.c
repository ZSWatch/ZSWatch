...
LOG_MODULE_REGISTER(notificationUI_app, LOG_LEVEL_DBG);
                                  ...
                                  lv_group_t *group)
{
    ...
    /*
        ...
        lv_obj_clear_flag(ui_ImgButtonClearAll, LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE);
