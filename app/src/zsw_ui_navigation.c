...
LOG_MODULE_REGISTER(zsw_ui_navigation, CONFIG_ZSW_APP_LOG_LEVEL);
...
static const zsw_ui_navigation_callbacks_t *navigation_callbacks;
...
int zsw_ui_navigation_init(const zsw_ui_navigation_callbacks_t *callbacks)
{
    ...
    LOG_INF("UI Navigation initialized");
    return 0;
}
