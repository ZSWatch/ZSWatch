...
# IMPORTANT!!! VERY IMPRTANT! NEVER FORGET THIS:
- Always Build->Flash->Check logs! Normally logs for target are on /dev/ttyUSB0/1. If something needs UI navigation to access, instead add a hack in zsw_ui_controller.c for example to auto open an app or similar at boot.
- Uploading LLEXT Apps use west upload_fs --type lfs --ini_file app/boards/zswatch/watchdk/support/qspi_mx25u51245.ini
